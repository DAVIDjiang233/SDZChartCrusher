...
btn_tools.tools[global.tools-1][type]+=1;
if btn_tools.tools[global.tools-1][type]>=array_length(global.toolext[global.tools-1][type]) btn_tools.tools[global.tools-1][type]=0;
